        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 text-center heading-wrap">
              ...
              <p class="lead">Select One to Proceed</p>
            </div>
          </div>
        </div>
      </div>
        <div class="container">
          <div class="row">
            <div class="major-caousel js-carousel-1 owl-carousel">
              ...
              <div>
                <div class="media d-block media-custom text-center">
                  <a href="covid_ind/Tracker - Odisha/index.php"><img src="img/person_3.png" alt="Image Placeholder" class="img-fluid"></a>
                  <div class="media-body" style="background-color: #121212">
                    <h3 class="mt-0 text-white">ODISHA ANALYSIS</h3>
          ...
          <div class="col-md-5 mb-5">
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block">
                  <span class="d-block text-grey">Address:</span>
                  <span>34 Street Name,  Odisha, India</span></li>
                <li class="d-block" ><span class="d-block text-grey" >Phone:</span><span>+1 242 4942 290</span></li>
                <li class="d-block"><span class="d-block text-grey">Email:</span><span>info@eodisha.com</span></li>
              </ul>
            </div>
          </div>
