...
<!-- ======= Features Section ======= -->
        ...
        <ul class="nav nav-tabs row d-flex">
          <li class="nav-item col-3" data-aos="zoom-in">
            <a class="nav-link active show" data-toggle="tab" href="#tab-1">
              ...
              <h4 class="d-none d-lg-block"> HOSPITALS & TEST CENTERS</h4></a>
            </a>
          </li>
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="100">
            <a class="nav-link" data-toggle="tab" href="#tab-2">
              <i class="ri-body-scan-line"></i>
              <h4 class="d-none d-lg-block">TEMPORARY MEDICAL CAMPS URBAN </h4>
            </a>
          </li>
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="200">
            <a class="nav-link" data-toggle="tab" href="#tab-3">
              <i class="ri-sun-line"></i>
              <h4 class="d-none d-lg-block">TEMPORARY MEDICAL CAMPS RURAL</h4>
            </a>
          </li>
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="300">
            <a class="nav-link" data-toggle="tab" href="#tab-4">
              <i class="ri-store-line"></i>
              <h4 class="d-none d-lg-block">COVID ODISHA UPDATES</h4>
            </a>
          </li>
        </ul>
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>HOSPITALS & TEST CENTERS.</h3>
                <p class="font-italic">
                  The following map locates all the test centers and hospitals in Odisha for the treatment & diagnosis of COVID-19.
                </p>
                <ul>
                ...
                <a href="https://odishacovidgis.in/Home/CoViDHospitalsandTestCenters">
 <button id="mapsbtn">VIEW MAP</button></a>
          ...
          <div class="tab-pane" id="tab-2">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>MEDICAL CAMPS IN URBAN AREAS</h3>
                
                <p class="font-italic">
                  Temporary medical camps in urban areas placed on the map of Odisha.
                </p>
                <ul>
                  <li><i class="ri-check-double-line"></i> Treatment camps for Covid19 to treat patients and provide locations for quarentine. </li>
                  
                           
                </ul>
                               <a href="https://odishacovidgis.in/Home/urbanTMC">
 <button id="mapsbtn">VIEW MAP</button></a>
              </div>
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>MEDICAL CAMPS IN RURAL AREAS</h3>
                <p>
                Temporary medical camps in rural areas placed on the map of Odisha.
                </p>
                <ul>
                  <li><i class="ri-check-double-line"></i> Treatment camps in rural areas for Covid19 to treat patients and provide locations for quarentine. </li>
                  
                           
                </ul>
                <a href="https://odishacovidgis.in/Home/TMCAdequacy">
 <button id="mapsbtn">VIEW MAP</button></a>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>Clinics  & Testing centers in ODISHA</h3>
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i> <n2 >ODISHA CONFIRMED<h2>
                  <n2 id="dc"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>ODISHA RECOVERED<h2>
                  <n2 id="dr"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>ODISHA DEATHS<h2>
                  <n2 id="dd"><h2></li>
                </ul>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
...
Array.prototype.sum = function (prop) {
    ...
    var DelhiConfirmed = covid_data[26].districtData.sum("confirmed");
    document.getElementById("dc").innerHTML = DelhiConfirmed
    var DelhiDeceased = covid_data[26].districtData.sum("deceased");
    document.getElementById("dd").innerHTML = DelhiDeceased
        var DelhiRecovered = covid_data[26].districtData.sum("deceased");
...
<i class="bx bxs-quote-alt-right quote-icon-right"></i></p>
          ...
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle button" href="https://covid360orissa.secure.force.com/Registration/">GO TO SELF ASSESSMENT</a>
          </div>
        </div>
