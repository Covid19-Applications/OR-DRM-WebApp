          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i> Odisha Health Care.[Address: Plot No, 699, Saheed Nagar, Bhubaneswar, Odisha 751007]</li>
                  <li><i class="ri-check-double-line"></i> Regional Medical Research Centre, Bhubaneshwar</li>
                  <li><i class="ri-check-double-line"></i> All India Institute of Medical Sciences, Bhubaneshwar</li>
                  <li><i class="ri-check-double-line"></i> SCB Medical College and Hospital, Cuttack</li>
                </ul>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
        ...
        <div class="container-fluid">
          <div class="row" data-aos="fade">
            ...
            <div class="container" style="position: center;">
              <CENTER>
<img class="responsive" src="img/person_3.png">
</CENTER>
</div>
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                 <?php
                                   $query = "SELECT * FROM healthcare WHERE state='odisha'";
...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN ODISHA</h1>
  <center>
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.."></center>
  ...
  <table  class="table  table-hover sortable" id="myTable">
   ...
   <!--  <tr>
      ...
      <th style="background-color: white">Health Facility Name</th>
      <th style="background-color:white">Facility Type</th>
      <th style="background-color: white">Landline Numbers </th>
      <th style="background-color: white">Address</th>
      <th style="background-color: white">District</th>
      <th style="background-color: white">State</th>
