...
If Condition deteriorates consult a psychologist/doctor.
            ...
            <a href="https://www.vandrevalafoundation.com/" class="btn-learn-more">CONTACT A DOCTOR</a>
          </div>
        </div>

      </div>
    </section><!-- End About Section -->
   <section id="cta" class="cta" style="background-color: brown">
      <div class="container" >

        <div class="row" data-aos="zoom-out">
          <div class="col-lg-9 text-center text-lg-left">
            <h2 style="color: grey">ELIZA---OUR VIRTUAL HEALTH COUNSELLOR</h2><br>
           <p> <i class="bx bxs-quote-alt-left quote-icon-left"></i>
Eliza provides protection of user data and helps users input how they feel and gives responses accordingly with almost human like efficiency.Cosult a doctor option is provided for better results and help patients and family members as well as people having mental issues due to the ongoing pandemic.
