...
if(isset($_POST['vol_form']))
{
    ...
    $query = "INSERT INTO `volunteers`(`name`, `email`, `service`,`pre_add`,`per_add`,`education`,`experience`, `phone`,`sector`, `message`) VALUES ('$name','$email', '$service','$pre_add','$per_add','$education','$experience', '$phone','$sector', '$message')";
